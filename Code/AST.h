...
{eNegative} Unop_e;
typedef enum
{eAssign,eCall,eRet,eWhile,eFor,eIf,eCompound,eSwitch,eSemi} Stmt_e;
typedef enum
{eUnop,eAddi,eMult,eRela,eEqlt,eCallExpr,eIntnum,eFloatnum,eId,eExpr} Expr_e;
typedef enum
{ePlus,eMinus} Addi_e;
typedef enum
{eMulti,eDiv} Mult_e;
